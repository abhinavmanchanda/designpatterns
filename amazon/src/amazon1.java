...
class Item
{
    ...
    public Item(int productType, String name, int price, String specs, String author,String publisher,String colour,String singer,String album,String Language,String category) 
    {
...
class amazon1
{
    public static void main(String [] args)
    {
        ...
        Item item1=new Item(1,"book",100,null,"author","abc publications",null,null,null,null,null);
        String str=item1.productDetails();
        System.out.println("details:"+str);
        item1.buy();
        Item item2=new Item(2,"item",100,"specs",null,null,"grey",null,null,null,null);
        String str2=item2.productDetails();
        System.out.println("details:"+str2);
        item2.buy();
        Item item3=new Item(3,"song",100,null,null,null,null,"singer","album","language","category");
